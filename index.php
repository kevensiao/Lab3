<?php
    ...
    function getPlayers($number){
        $player = array();
        $player[] = array('name' => "Trump", 'color' => "#ab16fd");
        $player[] = array('name' => "Kim", 'color' => "#d71c3a");
        $player[] = array('name' => "Macron", 'color' => "#9f1b45");
        $player[] = array('name' => "Elizabeth", 'color' => "#a18e33");
        $player[] = array('name' => "Putin", 'color' => "#91ba4d");
        shuffle($player);
        $players = array();
